//与rainbow命令相关的代码，生成一个gateway或者service类型的微服务程序包，初始化包内代码和配置
package main
...
func main() {
	var cmdNew = &cobra.Command{ //new命令，生成一个微服务初始程序包
	...
	var rootCmd = &cobra.Command{Use: "rainbow"}
